 ...
 * 
 * @author poll
 * @version $Id: DESedeCoder.java, v 0.1 2016�?1�?5�?下午6:35:40 poll Exp $
 */
public abstract class DESedeCoder extends SecurityCoder {
    ...
    /**
     * 加密/解密算法 / 工作模式 / 填充方式
     * DESede/ECB/NoPadding  DESede/ECB/PKCS5Padding  DESede/CBC/PKCS5Padding
     */
    public static final String CIPHER_ALGORITHM_ECB_PKC5 = "DESede/ECB/PKCS5Padding";
    ...
    public static byte[] decrypt(byte[] data, byte[] key) throws InvalidKeyException, NoSuchAlgorithmException,
        ...
        Key k = toKey(key);
        // 实例�?
        Cipher cipher = Cipher.getInstance(CIPHER_ALGORITHM_ECB_PKC5);
        // 初始化，设置为解密模�?
